...
function gotResult(error, results){
    if(error){
        ...
        document.getElementById("name_span").innerHTML = "Your Sketch:" + drawn_sketch
        document.getElementById("acc_span").innerHTML = 'Confidence' + Math.round(results[0].confidence * 100) + '%';
    }}